...
def test():
    ...
    test_case(hand, top_card, artificialPlayer, (("blue"), 1), "1POS")  # 1 possible card

    top_card = (("blue"), 1)
    hand = [(("blue"), 1)]
    test_case(hand, top_card, artificialPlayer, (("blue"), 1), "1POS-2")  # 2possible cards

    top_card = (("blue"), 1)
    hand = [(("red"), 1), (("red", "blue"), 1), (("red"), 1), (("red"), 1)]
    test_case(hand, top_card, artificialPlayer, (("red", "blue"), 1), "1POS-Bicolor")  # 1 possible card with 2 colors

    top_card = (("blue"), 1)
    hand = [(("red"), 1), (("blue", "red"), 1), (("red"), 1), (("red"), 1)]
    test_case(hand, top_card, artificialPlayer, (("blue", "red"), 1), "1POS-Bicolor")   # 1 possible card with 2 colors changed

    top_card = (("blue"), 1)
    hand = [(("wild"), 1), (("blue", "red"), 1), (("red"), 1), (("red"), 1)]
    test_case(hand, top_card, artificialPlayer, (("wild"), 1), "WILD")                    # wildcard test

    top_card = (("blue"), 1)
    hand = [(("red"), 1)]
    test_case(hand, top_card, artificialPlayer, "NOPE", "NOPE")              # no card available

    top_card = (("blue"), 1)
    hand = [(("red"), 1), (("blue"), 28), (("blue"), 14), (("red"), 1)]
    test_case(hand, top_card, artificialPlayer, (("blue"), 14), "Lower-Value")      # lowest value card

    top_card = (("blue"), 1)
    hand = [(("red"), 1), (("blue"), 28), (("blue", "red"), 28), (("red"), 1)]
    test_case(hand, top_card, artificialPlayer, (("blue", "red"), 28), "Bicolor")     #  2 Cards with same value, choose the card with 2 colors

    top_card = (("blue", "red"), 1)
    hand = [(("red"), 1), (("blue"), 1), (("red"), 1), (("red"), 1)]
    test_case(hand, top_card, artificialPlayer, (("red"), 1), "Frequency1")      # Choose the color which is the rarest, choose the red one not the blue

    top_card = (("blue", "red"), 1)
    hand = [(("blue"), 1), (("red"), 1), (("red"), 1), (("red"), 1)]
    test_case(hand, top_card, artificialPlayer, (("red"), 1), "Frequency2")      # same here chosse the red

    top_card = (("blue", "red"), 1)
    hand = [(("blue"), 1), (("red"), 1), (("blue"), 1), (("blue"), 1)]
    test_case(hand, top_card, artificialPlayer, (("blue"), 1), "Frequency3")        # same test choose the blue one
